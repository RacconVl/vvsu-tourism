...
const QUIZZES: QuizData[] = [
  ...
  {
    id: 6,
    title: "Гастрономия Владивостока",
    description: "Проверьте знания о кулинарном облике Владивостока и уникальных морепродуктах Японского моря.",
    category: "culture",
    difficulty: "easy",
    xpReward: 150,
    estimatedMinutes: 8,
    imageUrl: "https://images.unsplash.com/photo-1553361371-9b22f78e8b1d?w=600",
    isCompleted: false,
    bestScore: null,
    questions: [
      {
        id: 1,
        question: "Какой морепродукт называют «владивостокским жемчугом» и считают символом гастрономии региона?",
        options: ["Устрица", "Морской гребешок", "Краб-стригун", "Трепанг"],
        correctIndex: 1,
        explanation: "Приморский гребешок — крупный двустворчатый моллюск — считается гастрономическим символом Владивостока благодаря нежному вкусу и широкой доступности.",
      },
      {
        id: 2,
        question: "Как называется традиционный рынок морепродуктов в центре Владивостока?",
        options: ["Привозная площадь", "Рыбный базар на набережной", "Зелёный угол", "Спортивная набережная"],
        correctIndex: 1,
        explanation: "Рыбный базар на набережной Спортивной гавани — ключевое место для покупки свежих морепродуктов: краба, гребешка, морского ежа и трепанга прямо с рыбацких лодок.",
      },
      {
        id: 3,
        question: "Какое блюдо является визитной карточкой гастрономических фестивалей Владивостока?",
        options: ["Борщ с морской капустой", "Варёный краб с соусом", "Блины с икрой минтая", "Уха из горбуши"],
        correctIndex: 1,
        explanation: "Варёный камчатский краб с имбирным или чесночным соусом — главное блюдо фестиваля «Дальневосточная кухня», ежегодно привлекающего тысячи гостей.",
      },
      {
        id: 4,
        question: "Какой напиток из Приморья получил признание на международных дегустациях?",
        options: ["Пиво «Владивостокское»", "Сидр из дальневосточных яблок", "Вино из амурского винограда", "Чай из листьев элеутерококка"],
        correctIndex: 2,
        explanation: "Вино из амурского (дальневосточного) винограда — уникальный продукт Приморья. Несколько местных виноделен завоевали медали на российских конкурсах.",
      },
      {
        id: 5,
        question: "Что такое «ламинария» в контексте приморской кухни?",
        options: ["Вид дальневосточной рыбы", "Морская капуста", "Способ маринования морепродуктов", "Традиционный суп"],
        correctIndex: 1,
        explanation: "Ламинария (морская капуста) — широко применяется в приморской кухне: в салатах, роллах и как самостоятельное блюдо. Богата йодом и микроэлементами.",
      },
      {
        id: 6,
        question: "Какая кухня оказала наибольшее влияние на гастрономию Владивостока?",
        options: ["Французская", "Японская, корейская и китайская", "Итальянская", "Среднеазиатская"],
        correctIndex: 1,
        explanation: "Близость к Японии, Китаю и Корее сформировала уникальный «тихоокеанский фьюжн»: суши, кимчи, дим-сам органично вписались в местную кулинарную культуру.",
      },
    ],
  },
  {
    id: 7,
    title: "Экотуризм Приморья",
    description: "Тест о заповедниках, редких животных и экологических маршрутах Дальнего Востока.",
    category: "ecology",
    difficulty: "medium",
    xpReward: 200,
    estimatedMinutes: 10,
    ...
    questions: [
      {
        id: 1,
        question: "Какое редкое животное является символом Сихотэ-Алинского заповедника?",
        options: ["Белый медведь", "Амурский тигр", "Снежный барс", "Дальневосточный леопард"],
        correctIndex: 1,
        explanation: "Амурский (уссурийский) тигр — крупнейшая кошка планеты — обитает в Сихотэ-Алинском биосферном заповеднике. Сегодня в Приморье живёт около 600 особей.",
      },
      {
        id: 2,
        question: "Где находится национальный парк «Земля леопарда»?",
        options: ["На Сахалине", "В Хабаровском крае", "На юго-западе Приморья", "На Курилах"],
        correctIndex: 2,
        explanation: "Нацпарк «Земля леопарда» (юго-запад Приморья) — единственное место на Земле, где сохранился дальневосточный леопард. Сегодня их насчитывается около 120 особей.",
      },
      {
        id: 3,
        question: "Что такое «кедрово-широколиственный лес» в контексте приморского экотуризма?",
        options: [
          "Искусственные лесополосы Приморья",
          "Уникальный биом с хвойными и лиственными деревьями, богатый флорой и фауной",
          "Заповедные плантации корейского кедра для заготовки орехов",
          "Зона отдыха в окрестностях Владивостока",
        ],
        correctIndex: 1,
        explanation: "Уссурийская тайга — смешанный лес из кедра, дуба, ясеня, лианы актинидии и аралии. Один из самых биоразнообразных лесов умеренного климата.",
      },
      {
        id: 4,
        question: "Какой остров в заливе Петра Великого является птичьим заповедником?",
        options: ["Остров Попова", "Остров Фуругельма", "Остров Рейнеке", "Остров Путятина"],
        correctIndex: 1,
        explanation: "Остров Фуругельма — место гнездования колоний чаек, бакланов и других морских птиц. Входит в состав Дальневосточного морского заповедника.",
      },
      {
        id: 5,
        question: "Что такое экотроп «Тропа Арсеньева»?",
        options: [
          "Морской маршрут вдоль побережья Приморья",
          "Пешеходный маршрут по Уссурийской тайге в честь исследователя",
          "Горнолыжная трасса в Сихотэ-Алине",
          "Велосипедная дорожка вокруг острова Русский",
        ],
        correctIndex: 1,
        explanation: "Экотропа имени В. К. Арсеньева проходит по маршрутам, которыми ходил знаменитый исследователь Дальнего Востока, и включает наблюдательные площадки и информационные стенды.",
      },
      {
        id: 6,
        question: "Какой морской заповедник расположен в акватории залива Петра Великого?",
        options: [
          "Охотский морской заповедник",
          "Дальневосточный морской заповедник",
          "Тихоокеанский биосферный резерват",
          "Япономорский охраняемый район",
        ],
        correctIndex: 1,
        explanation: "Дальневосточный морской заповедник (основан в 1978 г.) — первый морской заповедник СССР, охраняет уникальные экосистемы заливов Японского моря, включая коралловые рифы.",
      },
    ],
  },
  {
    id: 8,
    title: "Морское наследие Дальнего Востока",
    description: "Тест о флоте, мореплавателях и портовой истории Владивостока.",
    category: "history",
    difficulty: "hard",
    xpReward: 250,
    estimatedMinutes: 12,
    ...
    questions: [
      {
        id: 1,
        question: "Какой российский мореплаватель исследовал берега Японского моря и дал имена многим мысам Приморья?",
        options: ["Витус Беринг", "Иван Крузенштерн", "Геннадий Невельской", "Фёдор Литке"],
        correctIndex: 2,
        explanation: "Геннадий Иванович Невельской (1813–1876) доказал, что Сахалин — остров, и открыл для России устье Амура, а также исследовал побережье Японского и Охотского морей.",
      },
      {
        id: 2,
        question: "Что перевозил первый торговый рейс через Владивостокский порт в XIX веке?",
        options: ["Пушнину и чай", "Уголь и рыбу", "Военное снаряжение", "Зерно и муку"],
        correctIndex: 0,
        explanation: "Первые торговые суда доставляли во Владивосток и вывозили пушнину, чай, а также товары из Китая и Японии — порт быстро стал ключевым в торговле с АТР.",
      },
      {
        id: 3,
        question: "Как называется знаменитая подводная лодка-музей, открытая во Владивостоке?",
        options: ["С-56", "К-21", "Б-413", "Щ-421"],
        correctIndex: 0,
        explanation: "Гвардейская подводная лодка С-56 установлена на набережной Владивостока как мемориал. Участвовала в Великой Отечественной войне и совершила переход с Тихого океана на Север.",
      },
      {
        id: 4,
        question: "Какой российский флот базируется во Владивостоке?",
        options: ["Черноморский флот", "Балтийский флот", "Северный флот", "Тихоокеанский флот"],
        correctIndex: 3,
        explanation: "Владивосток — главная база Тихоокеанского флота ВМФ России. История флота во Владивостоке насчитывает более 160 лет.",
      },
      {
        id: 5,
        question: "Что такое «Арсенал» применительно к Владивостоку XIX века?",
        options: [
          "Первое здание военного ведомства на берегу бухты",
          "Хранилище вооружений для защиты порта",
          "Склад морских карт и навигационного оборудования",
          "Верфь для строительства военных кораблей",
        ],
        correctIndex: 1,
        explanation: "Арсенал во Владивостоке — военно-морской склад боеприпасов и вооружений, построенный в 1870-х годах для снабжения кораблей Сибирской флотилии.",
      },
      {
        id: 6,
        question: "В каком году был установлен первый маяк на подходах к Владивостоку?",
        options: ["1865", "1876", "1890", "1902"],
        correctIndex: 1,
        explanation: "Маяк Скрыплёва — первый маяк Владивостока, построен в 1876 году на острове Скрыплёва у входа в Уссурийский залив. Работает по сей день.",
      },
      {
        id: 7,
        question: "Какой исторический корабль дал название улице в центре Владивостока?",
        options: ["«Маньчжур»", "«Варяг»", "«Очаков»", "«Аврора»"],
        correctIndex: 0,
        explanation: "Транспорт «Манджур» (в переводе «маньчжур») — судно, с борта которого в 1860 году высадился десант и основал Владивосток. В его честь названа одна из центральных улиц.",
      },
    ],
  },
];
